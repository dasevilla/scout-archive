...
- (3) Do ONE of the following:
  ...
  - (c) Interview someone who might be your client (such as a prospective homeowner or business owner) if you were an architect. Find out what your client's requirements would be for designing a new home or business building. Write a short program including a list of requirements for the project, the functions of the building and site, how the functions relate to one another, and the goals of the project.
    ...
    **Resources:** [Architects Talk to Clients—First Meeting (video)](https://youtu.be/KjHGOvllSSE)
...
- (5) Find out about three career opportunities in architecture. Pick one and find out the education, training, and experience required for this profession. Discuss this with your counselor, and explain why this profession might interest you.
  ...
  **Resources:** [Becoming an Architect: More than Floor Plans (video)](https://youtu.be/rRbH8vbpxK4), [Should YOU Study Architecture? (Expectation vs. Reality) (video)](https://youtu.be/TG9pYJZWV7w), [Become an Architect (website)](https://www.ncarb.org/become-architect), [Careers in Architecture (website)](https://www.archcareersguide.com/careers/), [Architects: Salary, Career Path, Job Outlook, Education and More (website)](https://www.raise.me/careers/architecture-and-engineering/architects/), [Life of an Architect (website)](https://www.lifeofanarchitect.com/do-you-want-to-be-an-architect/)
...
- [Architecture merit badge workbook PDF](http://usscouts.org/mb/worksheets/Architecture.pdf)
- [Architecture merit badge workbook DOCX](http://usscouts.org/mb/worksheets/old/Architecture.docx)
