...
- (1) **Aviation Basics and Mechanics of Flight.** Do the following:
  - (a) Define "aircraft." Describe three kinds of aircraft today, and their typical uses.
    ...
    **Resources:** [Types of Aircraft (video)](https://youtu.be/QvfVX2TXeb0), [Basics of How a Glider Works (video)](https://youtu.be/pI8u8fQmtIo)
  - (b) Provide a brief overview of the evolution of flight, and discuss three notable times in history important to aviation.

    **Resources:** [The Wright Brothers, First Successful Airplane (1903) (video)](https://youtu.be/YDlk4Ky_ahs), [The First Flight Around the World—U.S. Army Air Service (1924) (video)](https://youtu.be/q_2AVyt9B_A), [First Solo Transatlantic Flight —Charles Lindbergh (1927)  (video)](https://youtu.be/_R3fGL67mas), [First Solo Transatlantic Flight—Amelia Earhart (1932) (video)](https://youtu.be/y-itPeJOyzI), [First Commercial Jet Airliner—de Havilland Comet (1949) (video)](https://youtu.be/7O_iQ5LMGXI), [First Commercial Supersonic Flight—The Concorde (1969) (video)](https://youtu.be/gH7MMJOOiUQ), [First Flight Around the World Without Refueling—Rutan Model 86 Voyager (1986) (video)](https://youtu.be/TunNolO9J4U), [FAA Approves Unmanned Aerial Vehicles (UAV's AKA Drones) (2006) (video)](https://youtu.be/WDp1DFih-po)
  - (c) Explain the difference between a fixed wing and a rotary wing aircraft, and the benefits of each.

    **Resources:** [Airplane or Helicopter—Which Should You Choose?  (video)](https://youtu.be/Qju0JTn3PvI)
  - (d) Explain the operation of piston, turbine, and jet engines.

    **Resources:** [The Internal Combustion Engine (video)](https://youtu.be/5tN6eynMMNw), [How a Turbine Engine Works (video)](https://youtu.be/kz5kv0RfeUc), [See a Jet Engine in Action! (video)](https://youtu.be/KjiUUJdPGX0)
  - (e) Using a model aircraft, describe the four forces that act on an aircraft in flight.

    **Resources:** [How Do Planes Fly? (video)](https://youtu.be/wFTHh-6jIT8?si=xxdao5Ldgl9Ll3S9)
  - (f) Explain how an airfoil generates lift, specifically noting Bernoulli's principle.

    **Resources:** [Bernoulli's Principle: How Planes Fly (video)](https://youtu.be/YrSUxgiwoFk)
  - (g) Identify and describe the aerodynamic control surfaces on the aircraft of your choice, and explain how they operate to control its attitude and direction of flight.
    ...
    **Resources:** [Aircraft Control Surfaces Explained (video)](https://youtu.be/XxrdhJanotw)
  - (h) Explain the purposes and functions of the various instruments found in a typical single-engine aircraft: attitude indicator, heading indicator, altimeter, airspeed indicator, turn and bank indicator, vertical speed indicator, compass, navigation, communication, and engine performance indicators.
    ...
    **Resources:** [Cessna Cockpit Tour (video)](https://youtu.be/NZn7Dd2jYFw), [How To Control an Airplane: How Does a Pilot Control the Plane? (video)](https://youtu.be/NLE9sDSRj-Y)
...
- (2) **Principles of Flight.** Do ONE of the following:
  - (a) Build a model FPG-9. Get others in your troop or patrol to make their own model, then organize a competition to test the precision of flight and landing of the models.
    ...
    **Resources:** [AMA FPG-9 Glider Instructions (PDF)](https://www.gocivilairpatrol.com/media/cms/AEX_MARC_Activity_2_AMA_FPG9_Glider_A8316FDFF99FD.pdf), [AMA FPG-9 Glider (video)](https://youtu.be/zU1DaUwPUhQ)
  - (b) Build a rubber-band driven balsa wood airplane. Fly the plane for 25 feet in a straight line, with a smooth landing.

    **Resources:** [Balsa Wood Plane (video)](https://youtu.be/rjuGw-oreyY)
  - (c) Build (or obtain) a fuel-driven or battery-powered electric model aircraft or drone. Obtain The Recreational UAS Safety Test (TRUST) certification, and fly the aircraft with a successful take-off and landing.
    ...
    **Resources:** [Learn (website)](https://www.faa.gov/uas/recreational_flyers/knowledge_test_updates), [Take the Test (website)](https://www.scouting.org/the-recreational-uas-safety-test/)
...
- (3) **Flight Operations.** Do TWO of the following:
  - (a) Using a flight simulator software package, set a course and fly the headings you have established with a successful take-off and landing.
    ...
    **Resources:** [Microsoft Flight Simulator (website)](https://www.scouting.org/skills/merit-badges/digital-resource-guides/aviation/3-a/#elementor-action%3Aaction%3Dpopup%3Aopen%26settings%3DeyJpZCI6IjIzODg4NSIsInRvZ2dsZSI6ZmFsc2V9))
  - (b) Under supervision, perform a preflight inspection of an aircraft.

    **Resources:** [How to Preflight a Cessna 172 (video)](https://youtu.be/4cwKZ0Q_Xug)
  ...
  - (d) Obtain and learn how to read an aeronautical chart. Measure a true course on the chart; correct it for magnetic variation, compass deviation, and wind drift to determine a navigational heading for an aircraft.
    ...
    **Resources:** [How To Read an FAA Sectional Aeronautical Chart (video)](https://youtu.be/4Z-yGYn4w-A)
...
- (4) **Airport Operations.** Do ONE of the following:
  ...
  - (b) Visit a Federal Aviation Administration facility: Airport Traffic Control Tower (ATCT), Terminal Radar Approach Control (TRACON), Air Route Traffic Control Center (ARTCC), or Flight Standards District Office (FSDO). Report on the operation and your impressions of the facility.
    ...
    **Resources:** [FAA's Facility Locator (website)](https://www.faa.gov/aircraft/air_cert/locate_office)
  - (c) Visit a military aviation facility. Learn how that facility supports defense and/or civilian activities. Report on the operation and your impressions of the facility.
    ...
    **Resources:** [Identify a Nearby Military Aviation Facility (website)](https://installations.militaryonesource.mil/)
  - (d) Visit an aviation museum or attend an air show. Report on your impressions of the museum or show, and what you learned from the experience.
    ...
    **Resources:** [Smithsonian Affiliations (website)](https://affiliations.si.edu/), [Air Shows (website)](https://www.airshowcenter.com/), [Miltary Air Shows (website)](https://www.milavia.net/airshows/), [Recreational Aviation Events (website)](https://www.eaa.org/eaa/events), [Find a Museum (website)](https://whichmuseum.com/place/united-states-2682?q=aviation)
...
- (5) **Personal & Professional Aviation Opportunities.** Do the following:
  ...
  - (b) Describe the benefits of the instrument rating.
    ...
    **Resources:** [How To Use Flight Instruments When Flying an Airplane (video)](https://youtu.be/pDciG07bauE), [What Is Instrument Flight Rules (IFR)? (video)](https://youtu.be/ZbxtvLj8CmA), [Instrument Rating \| Tips, Challenges & Benefits (video)](https://youtu.be/Nuzjui3toOA), [Your First Instrument Pilot's Lesson (video)](https://youtu.be/O3PJd893M8o)
  - (c) Explain the following: the commercial pilot certificate, the airline transport pilot certificate, and certified flight instructor (CFI).
    ...
    **Resources:** [Pilot Licenses Explained (video)](https://youtu.be/qMlfpncS7Mk&t=211), [Certified Flight Instructor (video)](https://youtu.be/ELv4oUNa-C4)
  - (d) Identify an Aviation Exploring Post and/or Civil Air Patrol facility in your area. Learn about their activities and membership requirements.
    ...
    **Resources:** [Aviation Exploring Post Visiting Denton TX Airport (video)](https://youtu.be/zH4Nq6f2SDA), [Aviation Exploring Posts (website)](https://www.exploring.org/aviation/), [Gallatin Cap Visiting Montana (video)](https://youtu.be/QHAoogkb6ts), [Find a Local CAP Squadron: (website)](https://www.gocivilairpatrol.com/)
  - (e) Identify three career opportunities that would use skills and knowledge in aviation. Pick one and research the training, education, certification requirements, experience, and expenses associated with entering the field. Research the prospects for employment, starting salary, advancement opportunities and career goals associated with this career. Discuss what you learned with your counselor and whether you might be interested in this career.
    ...
    **Resources:** [Careers in Aviation (video)](https://youtu.be/AQ75DC4WcS8), [Aerospace Engineer Careers (video)](https://youtu.be/bnxcib-8S4s), [Career as a Flight Dispatcher (video)](https://youtu.be/KP15W-uTp2c), [How To Become a Helicopter Pilot (video)](https://youtu.be/x5WrHPtpzk8), [Career as a Aircraft Maintenance Technician (video)](https://youtu.be/TCThd0Vr0cQ), [5 Qualities To Be a Good Air Traffic Controller (video)](https://youtu.be/GNN1gogcHdM), [Career as a Flight Attendant (video)](https://youtu.be/S6a3XVIMnHE), [Unseen Airport Jobs You Won't Believe Exist! \| Inside Hidden Roles That Keep Airports Running (video)](https://youtu.be/SCrPtl9R1jQ), [Airline and Commercial Pilots Occupational Outlook (website)](https://www.bls.gov/ooh/Transportation-and-Material-Moving/Airline-and-commercial-pilots.htm)
