...
- (1) Do the following:
  - (a) Discuss with your counselor the history of the game of chess.
    ...
    **Resources:** [A Brief History of Chess (video)](https://youtu.be/YeB-1F-UKO0)
  - (b) Research a famous chess player and what accomplishments made him or her famous. Discuss with your counselor.

    **Resources:** [Story of World Chess Champion Magnus Carlsen! (video)](https://youtu.be/TW0yJYab5YA), [The 'Queen of Chess' Who Defeated Kasparov (video)](https://youtu.be/1DgosX9_T2U), [Chess Champ Bobby Fischer on 60 Minutes (video)](https://youtu.be/GPuazOwq0aw)

- (2) Discuss with your counselor the following:
  - (a) Why chess is considered a game of planning and strategy.

    **Resources:** [Why Every Strategist Should Learn Chess (video)](https://youtu.be/4CVIO3Ey2_Y)
  - (b) The benefits of playing chess, including developing critical thinking skills, concentration skills, and decision-making skills, and how these skills can help you in other areas of your life.
    ...
    **Resources:** [14 Shocking Benefits of Playing Chess (video)](https://youtu.be/fyzWEXakASs)
  - (c) Sportsmanship and chess etiquette

    **Resources:** [The Morals of Chess by Benjamin Franklin (video)](https://youtu.be/C5LNdtayoKI), [Chess Etiquette (video)](https://youtu.be/71wh24-AYZk), [Understanding Resignation and Respect in Chess (video)](https://www.tiktok.com/@norwaychess/video/7524741028805430550)

- (3) Demonstrate to your counselor that you know each of the following. Then, using Scouting EDGE to teach someone who does not know how to play chess:
  ...
  **Resources:** [The EDGE Method of Teaching (PDF)](https://www.scouting.org/wp-content/uploads/2019/01/Teaching-Edge-Method.pdf)
  ...
  - (a) The name of each chess piece
    ...
    **Resources:** [Chess 101: Name the Pieces (video)](https://youtu.be/f8LOIdpLWIk)
...
- (4) Do the following:
  - (a) Demonstrate scorekeeping using the algebraic system of chess notation.
    ...
    **Resources:** [Learn How To Record Your Chess Games, Read Books and Communicate (video)](https://youtu.be/mADPCw-rhPI)
  - (b) Discuss the differences between the opening, the middle game, and the endgame.

    **Resources:** [What Is a Chess Opening? (video)](https://youtu.be/OYevDf-oCt0), [The Dreaded Middlegame (video)](https://youtu.be/mkOntF0rmSg), [What Is the Endgame in Chess? (video)](https://youtu.be/UL8Jo4lc1Ms), [A Beginner's Guide to Chess: Opening, Middlegame, and Endgame Principles (video)](https://youtu.be/cheyUEMgWDg)
  - (c) Explain four opening principles. Demonstrate for your counselor the first five moves of the following openings: Ruy Lopez, French Defense, Queen's Gambit Declined, Sicilian Defense.
    ...
    **Resources:** [The Ruy Lopez: The Opening Every Chess Player Must Know (video)](https://youtu.be/nx2HKfOHRBM), [The French Defense Chess Opening Explained in 4 Minutes by a Chess Master! (video)](https://youtu.be/vOw5BQYCfWA), [Learn the Queen's Gambit Declined (video)](https://youtu.be/ZEQWwuAa2-o), [Chess Openings: Sicilian Defense (video)](https://youtu.be/qzydxPgPKzs)
  - (d) On a chessboard, demonstrate Scholar's Mate, Fool's Mate, Légal Mate, Fried Liver Attack, and Noah's Ark Trap.

    **Resources:** [Fools Mate Scholar's Mate and a Nice Tactic (video)](https://youtu.be/jrUalgPaiPQ), [Legal's Mate Trap: Chess Opening Trick To Fool Your Opponent & Win Fast (video)](https://youtu.be/iEu3xT--f_k), [The Fried Liver Attack in 1 Minute (video)](https://youtu.be/EmYD8v81BY8), [Chess Trap: Noah's Ark Trap—Guy Lopez (video)](https://youtu.be/KskXvXxlkCM)
...
- (5) Do the following:
  - (a) Explain four of the following elements of chess strategy: exploiting weaknesses, force, king safety, pawn structure, space, tempo, and clock management.
    ...
    **Resources:** [How To Identify and Exploit Weaknesses (video)](https://youtu.be/kw5XkhM-DDI), [Only One Move Wins! (Understanding Forcing Moves) (video)](https://youtu.be/6T-Dt1JwANM), [The Top 5 Priorities for Any Chess Opening! (video)](https://youtu.be/4JzL_MWhK8o), [Pawn Structures in Chess (video)](https://youtu.be/iPrSVMKHSgo)
...
- (6) Explain to your counselor how chess tournaments are run, including the Swiss system tournament format, the round robin tournament format, pairings for each round, time controls, touch move, scoring, and chess ratings.

  **Resources:** [Why Swiss-Style Tournaments Are the BEST Tournaments! (video)](https://youtu.be/b8oV2dj4dgU), [How To Use a Chess Clock (video)](https://youtu.be/5nTkIEmJE2o), [Round Robin Tournament (video)](https://youtu.be/rKYsPvnm4eU), [How To Play: Touch Moves (video)](https://youtu.be/NPM8py0xHi8), [Chess Piece Values—How Much Is Each Chess Piece Worth? (video)](https://youtu.be/86Is6YemsyA), [How the Elo Rating System Works in Chess (video)](https://youtu.be/o8AWrRk5su0), [The Elo Rating System for Math Nerds (video)](https://youtu.be/AsYfbmp0To0)
...
- (7) Do ONE of the following:
  ...
  - (c) Organize and run a chess tournament with at least four players, plus you. Have each competitor play at least two games.
    ...
    **Resources:** [Example Tournament Chart (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Chess/chess_tournament_chart_4_players.pdf)
