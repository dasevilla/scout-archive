...
- (1) Do the following:
  - (a) Explain to your counselor the hazards you are most likely to encounter while participating in kayaking activities, including weather and water-related hazards, and what you should do to anticipate, help prevent, mitigate, and respond to these hazards.
    ...
    **Resources:** [Kayaking Tips—Cold Water and Winter Paddling (Wear, Gear, and Risks) (video)](https://youtu.be/xUUX1VI7i1I), [Top 5 Kayak Safety Rules for Beginners (video)](https://youtu.be/WMU4jNmlCQA)
  - (b) Review prevention, symptoms, and first-aid treatment for the following injuries or illnesses that can occur while kayaking: blisters, cold-water shock and hypothermia, heat-related illnesses, dehydration, sunburn, sprains, and strains.
    ...
    **Resources:** [OSHA Heat Illness Prevention Campaign (video)](https://youtu.be/Kr2ouLj1oW0), [How To Treat a Sunburn (video)](https://youtu.be/u0sLzfq_w9s), [First Aid Kit for Kayaking—What's in It? (video)](https://youtu.be/iLbL7fffGAk), [Cold Water Shock—How To Deal With Cold Water Shock (video)](https://youtu.be/rH3gZuSr6Y8)
  - (c) Review the Scouting America Safety Afloat policy. Explain to your counselor how this applies to kayaking.

    **Resources:** [Safety Afloat (website)](https://www.scouting.org/health-and-safety/safety-moments/safety-afloat/)
...
- (2) Before doing requirements 3 through 8, successfully complete the Scouting America swimmer test. **Note:** See the *Swimming* merit badge pamphlet for details about the Scouting America swimmer test.
  ...
  **Resources:** [Swimming Merit Badge Pamphlet (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Pamphlets/Swimming.pdf)
...
- (4) Do the following:
  - (a) Name and point out the major parts of a kayak.
    ...
    **Resources:** [Kayak Overview (video)](https://youtu.be/JJGYUG8Bfxc)
  - (b) Review the differences in the design between recreational, whitewater, and sea or touring kayaks. Include how length, width, stability, and rocker are involved in the design of each type.
    ...
    **Resources:** [How To Choose the Right Kayak for All Types of Flatwater Paddlers (video)](https://youtu.be/2xlCx8ckfR8)
  - (c) Explain the care, maintenance, and storage of a kayak.

    **Resources:** [How To Clean and Maintain Your Kayak (video)](https://youtu.be/DThGAXJ8hM8)

- (5) Discuss the following:
  - (a) Correct methods for the use of a kayak paddle

    **Resources:** [How To Hold a Kayak Paddle (video)](https://youtu.be/RZLtB7BmNAc), [Proper Technique for Paddling a Kayak (video)](https://youtu.be/v0-efrwppWQ)
  - (b) Parts of a paddle

    **Resources:** [Kayak Paddles (website)](https://www.boat-ed.com/paddlesports/paddlesports/studyGuide/Kayak-Paddles/11109901_52043/)
  - (c) The care and maintenance of a paddle

    **Resources:** [Kayak Paddle Maintenance (website)](https://floridasplendors.com/kayak-paddle-maintenance-essential-tips/)
...
- (6) Using a properly equipped kayak with an open cockpit, a sit-on-top, or an inflatable kayak, do the following:
  - (a) Safely capsize and perform a wet exit.
    ...
    **Resources:** [Kayak Wet Exit—How To Get Out of Your Kayak (video)](https://youtu.be/blJFzirv3-E)
  - (b) Reenter the kayak with assistance from a buddy boat.

    **Resources:** [How To Re-Enter a Sit Inside Kayak for Beginners (video)](https://youtu.be/O_-a5ngnRew), [Sea Kayak T-Rescue: Deep Water Rescue / How To Get Back in Your Kayak With Help (video)](https://youtu.be/YSRCAdCSj8Q), [Master the Sea Kayak Scoop Rescue for Injured Paddlers (video)](https://youtu.be/wE5y_DW2h04), [Heel Hook—Kayak Rescue (video)](https://youtu.be/j-zpJQeiaNc)
  - (c) Demonstrate a kayak-over-kayak rescue.

    **Resources:** [Sea Kayak T-Rescue: Deep Water Rescue / How To Get Back in Your Kayak With Help (video)](https://youtu.be/YSRCAdCSj8Q)
  - (d) Demonstrate the HELP position.

    **Resources:** [Help/Huddle Position (video)](https://youtu.be/Z5X1K1I8xEc)
  - (e) Capsize the kayak, swim it and the paddle to shore, and empty water from the kayak with assistance if needed.

    **Resources:** [White Water Kayak—Swim to Shore (video)](https://youtu.be/ykvS7iHeC_g)

- (7) As a solo paddler, use a properly equipped kayak to demonstrate the following:
  - (a) Forward stroke

    **Resources:** [Kayak Forward Stroke (video)](https://youtu.be/yz00070X04o)
  - (b) Backstroke

    **Resources:** [Kayak Reverse Stroke (video)](https://youtu.be/O-feCLPf-qw)
  - (c) Forward sweep

    **Resources:** [Kayak Sweep Strokes (video)](https://youtu.be/GWpaWh8AcZw)
  - (d) Reverse sweep

    **Resources:** [Kayak Reverse Stroke (video)](https://youtu.be/O-feCLPf-qw)
  - (e) Draw stroke

    **Resources:** [Kayak Draw Stroke—In Water Recovery (video)](https://youtu.be/H3G8Viju93I)
  - (f) Stern draw

    **Resources:** [Stern Draw (video)](https://youtu.be/0bWe37-jaD8)
...
- (8) As a solo paddler, use a properly equipped kayak to demonstrate the following:
  - (a) Paddle a straight line for 15 to 20 boat lengths using appropriate strokes while maintaining trim and balance of the kayak.
    ...
    **Resources:** [Paddling a Kayak in a Straight Line (video)](https://youtu.be/7CThukQ8b0s)
  - (b) Spin or pivot from a stationary position 180 degrees (half circle) to the right and left within two boat lengths.

    **Resources:** [Fast Sea Kayak Turn—Turning a Sea Kayak 180 Degrees Efficiently (video)](https://youtu.be/eKGsnIat1NQ)
  - (c) Move abeam to the right 10 feet and to the left 10 feet.

    **Resources:** [How To Turn a Kayak (video)](https://youtu.be/1j1DuKmZk1o)
  - (d) Stop the boat in one boat length.

    **Resources:** [Paddle Strokes, the Emergency Stopping Procedure (video)](https://youtu.be/kRUpSLUFMII)
  ...
  - (f) Move the kayak backward three to four boat lengths using appropriate and effective reverse strokes.
    ...
    **Resources:** [Reverse Stroke (video)](https://youtu.be/O-feCLPf-qw)
