...
- (1) **Safety.** Discuss all safety procedures with your counselor before beginning your modelmaking project, and explain why each is important—both in traditional and computer-assisted design and construction:
  - (a) Explain the requirements for personal safety when using modelmaking hand tools, and when to use proper protective equipment.
    ...
    **Resources:** [Toolbox Talk on Hand Safety | This Is Why You Should Be Wearing Gloves (video)](https://youtu.be/d4zQENWPohw), [X-Acto Knife: Basic Safe Use in Under 4 Minutes (video)](https://youtu.be/_O3PJBA5fiA), [3-D Printing Safety (website)](https://ehs.vt.edu/programs/occupational-safety/3dprinting.html), [5-Minute 3D-Printing Training Video—Safety & Basics (video)](https://youtu.be/_Kv_b_9s3H4), [3D Printer Resin: Proper Precautions You Must Take (video)](https://youtu.be/7v2iXpw7vVc)
  - (b) Explain digital safety best practices when using computer design software, and digital fabrication tools.

    **Resources:** [Digital Safety (video)](https://filestore.scouting.org/filestore/YPSAT/YT%20Mod1%20Final%20Master%20Small.mp4?_gl=1*1npxm9d*_ga*MTk1Mzg0NzM1OS4xNzU1NjM1NDc0*_ga_20G0JHESG4*czE3NTc2MjAyMjAkbzIxJGcxJHQxNzU3NjIwMjU2JGoyNCRsMCRoMA..*_gcl_au*MTU0OTgwNjcyLjE3NTU2MzU0NzQ.&_ga=2.243209291.839854577.1757346029-1953847359.1755635474)
  - (c) Explain what precautions to take when using flammable or hazardous materials.

    **Resources:** [Flammable Liquids—Safe Handling: Essential Tips for Workplace Safety (video)](https://youtu.be/cPPUZKWzPWQ), [Is Super Glue Non-Toxic? The Real Dangers Explained (website)](https://biologyinsights.com/is-super-glue-non-toxic-the-real-dangers-explained/), [6 Health and Safety Tips Every Painter Should Know (video)](https://youtu.be/KZ27mz6Yc-4)
...
- (2) **Types of Models and Materials.** Do the following:
  - (a) Explain the uses for each of the following types of models: architectural, structural, process, mechanical, and industrial.
    ...
    **Resources:** [10 Types of Architecture Models and How To Make Them (website)](https://www.re-thinkingthefuture.com/architectural-community/a3093-10-types-of-architecture-models-and-how-to-make-them/), [12 Building Models That Architects Deliver (website)](https://www.architecturelab.net/software/models/), [Model Types and Uses (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Model%20Design%20%26%20Building/Model%20Types.pdf)
  - (b) Explain to your counselor how either traditional and/or computer design tools can be used to create plans, simulate function, visualize models, and assist in constructing or fabricating parts.
    ...
    **Resources:** [What Is CAD?—Computer-Aided Design Explained (video)](https://youtu.be/vID5gpALgxk)
  - (c) Describe to your counselor traditional and modern materials and fabrication methods that can be used for making these models. Include physical and digital materials and methods.
    ...
    **Resources:** [Architectural Model Making — Material Selection—An Architect's Guide (Part 2) (video)](https://youtu.be/X8u3zhDUDzE), [3D Printing 101: The Ultimate Beginner's Guide (video)](https://youtu.be/2vFdwz4U1VQ)
...
- (3) **Planning Your Project.** With your counselor's advice, select a subject from requirement 4 for your model project. (You must not use a pre-made kit; your project must be your original design.)
  ...
  - (b) Make a list of materials.
    ...
    **Resources:** [Glues for Plastic Models and How To Use Them (video)](https://youtu.be/pif0tkshv64)
  - (c) Create a list of the required tools.

    **Resources:** [Best Scale Modeling Supplies for Beginners | 10 Essential Tools To Get Started (video)](https://youtu.be/8pzIu5SHdi8), [Building Your First Scale Model Car: Basic Hand Tools (video)](https://youtu.be/Zx37zrGLMUI)
...
- (4) **Build Your Model.** Do ONE of the following using physical and/or computer design methods. Before beginning any model, discuss your approach with your counselor, including the possible use of computer design software such as CAD or 3D modeling tools. Present your plans and completed model to your counselor.
  - (a) **Architectural Model.** Design and build a model of a house to a scale of 1⁄4" = 1'0" (1:48 scale). Begin by creating floor plans and elevations. Include windows, doors, and structural elements. Discuss with your counselor the materials you intend to use, the amount of detail required, outside treatment (finish, shrubbery, walks, etc.), and color selections. You may choose to 3D print elements or use laser-cut parts based on using computer design. Present both your design and final model to your counselor for evaluation.

    **Resources:** [How To Read an Architectural Scale Where 1/4"=1' (video)](https://youtu.be/Zn2vkbtdSPA), [Architectural Model Making Tips + Tricks—An Architect's Guide (video)](https://youtu.be/SxCYtRfCm8o), [30 Minute Study Model—Here's How (video)](https://youtu.be/t7GpYvyQoEs), [How To Make Trees and People for Architecture Scale Models (video)](https://youtu.be/aqxjN_IFSRs), [Adam Savage's One Day Builds: Wood Architectural Model! (video)](https://youtu.be/qjNphb6mroM)
  ...
  - (d) **Mechanical Model.** Build a model of a mechanical device that incorporates at least two of the six simple machines. You can use digital tools to design and simulate the device before constructing it. Once your design is approved by your counselor, build a working physical model using materials such as wood, plastic, or 3D printed parts. Present your models to your counselor and be prepared to discuss materials used, the machine's function, and challenges you encountered during the construction process.
    ...
    **Resources:** [Simple Machines (video)](https://youtu.be/A6XWZTp6iMg), [Examples of Simple Machines Used in Everyday Life (video)](https://youtu.be/_fOA4nCWYms)
  - (e) **Industrial Model.** Build a model of an actual passenger-carrying vehicle to a scale of 1" = 1'0" or 1 ⁄2" = 1'0" (1:12 or 1:24 scale). Begin by measuring a real vehicle and modeling it from multiple views (top, front, rear, sides). You can draw it or use computer design software. From your plans, build a physical model or use digital rendering or 3D printing to produce the final version. Discuss with your counselor which parts were most challenging.

    **Resources:** [How To Read an Architectural Scale Where 1"=1' (video)](https://youtu.be/01ZFKZoPkjg), [Orthographic Drawing—Simplified (video)](https://youtu.be/SdLegfoMXNA), [5 Ways To Sketch a Car With Accurate Proportions (website)](https://luukminkman.com/en/blog/how-to-sketch-a-car-with-accurate-proportions/)
...
- (5) **Special-Effects Fantasy Model.** Design and build a fantasy spacecraft model suitable for a science-fiction film, using traditional modeling and/or computer design techniques. Determine an appropriate scale for your design—one that makes practical sense. Do the following:
  ...
  **Resources:** [Easy Spaceship Modeling Techniques! (video)](https://youtu.be/LOdcwBhEUcs), [Adam Savage's One Day Builds: Kit-Bashing and Scratch-Building! (video)](https://youtu.be/ZfvtGrhYk0I)

  - (a) Research real-world aircraft, submarines, and naval ships for design inspiration.

    **Resources:** [5 Most Influential Submarine Designs Ever (website)](https://www.hisutton.com/5-most-influential-submarine-designs-ever.html), [15 Future Aircraft Designs That Will Blow Your Mind (video)](https://youtu.be/MRn47LCGtco)
...
- (6) **Careers.** Explore careers related to this merit badge. Research one career to learn about the training and education needed, costs, job prospects, salary, job duties, and career advancement. Your research methods may include—with your parent or guardian's permission—an internet or library search, an interview with a professional in the field, or a visit to a location where people in this career work. Discuss with your counselor both your findings and what about this profession might make it an interesting career.
  ...
  **Resources:** [How To Be a Professional Model Maker—My Journey (video)](https://youtu.be/xRMVKOgxo0s), [How To Get a Job in 3D Printing (video)](https://youtu.be/gKczfa3tXBo), [30 Jobs for Model Makers (Precision Pioneers) (website)](https://interviewguy.com/jobs-for-model-makers/)
