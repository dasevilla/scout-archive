...
- (1) **Safety.** Do the following:
  - (a) View the Personal Safety Awareness "Digital Safety" video (with your parent or guardian's permission.)
    ...
    **Resources:** [Scouting Digital Safety Video (video)](https://filestore.scouting.org/filestore/YPSAT/YT%20Mod1%20Final%20Master%20Small.mp4)
  - (b) Discuss first aid and prevention for the types of injuries that could occur during programming activities, including repetitive stress injuries and eyestrain.
    ...
    **Resources:** [Treating Repetitive Stress (video)](https://www.youtube.com/shorts/1yp0jOyARCk), [Treating Eye Strain (video)](https://www.youtube.com/watch?v=j3ff4aeItl0), [5 Tips to Reduce Eye Strain (website)](https://www.uab.edu/news/health-medicine/new-uab-eye-care-clinic-helps-improve-vision-in-the-workplace)
...
- (2) **History.** Discuss with your counselor the history of programming and the evolution of programming languages, including at least three milestones related to the advancement or development of programming over time.
  ...
  **Resources:** [5 Minutes of Programming Language History (video)](https://youtu.be/K5yv7dY17EA), [Example With Code Examples and Pictures (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req2-History.docx), [Text Descriptions of Historical Progression of Programming Languages (website)](https://www.computer.org/publications/tech-news/insider-membership-news/timeline-of-programming-languages), [Computer History Museum Timeline With Pictures (website)](https://www.computerhistory.org/timeline/software-languages/), [History Handout (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req2-History.pdf)

- (3) **General Knowledge.** Do the following:

  **Resources:** [General Knowledge Handout (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req3-General.pdf)
  ...
  - (a) Create a list of five popular programming languages in use today and describe which industry or industries they are primarily used in and why.
    ...
    **Resources:** [Eight Popular Programming Languages, Their Industries and Coding Examples (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req3-General.docx)
  - (b) Describe three different programmed devices you rely on every day.

- (4) **Intellectual Property.** Do the following:

  **Resources:** [Intellectual Property Handout (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req4-IP.pdf)

  - (a) Explain the four types of intellectual property used to protect computer programs.

    **Resources:** [Four Different Types of Intellectual Property (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req4-IP.docx)
  - (b) Describe the difference between licensing and owning software.

    **Resources:** [The Difference Between Licensing and Owning Software (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req4-IP.docx)
...
- (5) **Project.** With your counselor's guidance, select three different programming languages and development environments. For each subrequirement below, do the following: Write or modify a program using the indicated programming language and development environment. The program must take input and produce output based on computations and decisions made on the input. Debug and demonstrate the program to your counselor. Explain how each program processes inputs, makes decisions based on those inputs, and provides outputs based on computations and decision making.
  ...
  **Resources:** [Project Handout (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req5-Project.pdf)
  ...
  - (a) In the first language and environment, write or modify a program, debug and demonstrate, and explain as above.
    ...
    **Resources:** [Scout Life Programming Merit Badge (website)](https://scoutlife.org/merit-badges/programming-merit-badge/)
  - (b) In the second language and environment, write or modify a program, debug and demonstrate, and explain as above.

    **Resources:** [Programming Merit Badge Welcome! From AutomationDirect (video)](https://www.youtube.com/watch?v=s07aEbPwThM)
  - (c) In the third language and environment, write or modify a program, debug and demonstrate, and explain as above.

    **Resources:** [Codedex / Start Your Coding Adventure (website)](https://www.codedex.io/)

- (6) **Careers.** Do ONE of the following:

  **Resources:** [Careers Handout (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req6-Careers.pdf)
...
- [Programming merit badge workbook PDF](http://usscouts.org/mb/worksheets/Programming.pdf)
- [Programming merit badge workbook DOCX](http://usscouts.org/mb/worksheets/Programming.docx)
