...
- (1) **Hazards and First Aid.** Do the following:
  ...
  - (1) Dehydration
    ...
    **Resources:** [Dehydration (video)](https://youtu.be/KahsIEbFROI)
  - (2) Heatstroke

    **Resources:** [Heat Exhaustion vs Heat Stroke (video)](https://youtu.be/8gn3DEYOPuE), [Heat Stroke (video)](https://youtu.be/PpHM4DfPZQU)
  - (3) Hypothermia

    **Resources:** [Hypothermia (video)](https://youtu.be/my6JB41apTw)
  - (4) Shock

    **Resources:** [Recognizing and Treating Shock (video)](https://youtu.be/S0aCHtEn7to), [Shock (video)](https://youtu.be/AHls9NRGCZk)
  - (5) Blisters

    **Resources:** [Blisters (video)](https://youtu.be/5y2QIZwzfuI)
  - (6) Eye injuries

    **Resources:** [First Aid for Eyes (video)](https://youtu.be/zULuu4QwX4s)
  - (7) Ankle and knee sprains

    **Resources:** [Figure 8 Ankle Wrap (video)](https://youtu.be/Z_kCbkxR4xk), [Orthopedic Injuries (website)](https://www.scouting.org/health-and-safety/safety-moments/orthopedic-injuries/), [Bone, Joint, and Muscle Injuries (video)](https://youtu.be/BAUiP1P3GE0)
  - (8) Bug bites of chiggers, ticks, mosquitoes, and biting gnats

    **Resources:** [Tick Checks (video)](https://youtu.be/mwAHhOwqeX4), [Mosquito Bites (video)](https://youtu.be/m4iapNcv8-Q)
  - (9) Bee stings

    **Resources:** [Bee Stings (video)](https://youtu.be/01Po5RTNfhs), [Treatment of a Bee Sting (video)](https://youtu.be/nv2BUxZMWAI)
  - (10) Bites of spiders

    **Resources:** [What You Need To Know About Spider Bites (video)](https://youtu.be/QQVYRvD55Uc)
  - (11) Sting of a scorpion

    **Resources:** [Scorpion Stings (video)](https://youtu.be/YFI2VMy6mT0)
  - (12) Bite of a wild mammal

    **Resources:** [Treatment of Animal Bites (video)](https://youtu.be/X0HYjzU2NKk)
...
- (2) **Staying and Getting Found.** Do the following:
  - (a) Explain how a trip plan and the buddy system help Scouts with staying found and getting found.
    ...
    **Resources:** [How To Plan an Adventure (video)](https://youtu.be/79WYqkiExZU), [Scout Trip Planning (website)](https://scoutingmagazine.org/2007/03/outdoor-smarts-lost-and-found/), [Why You Should Make Trip Plans (website)](https://www.adventurealan.com/why-you-should-make-a-trip-plan/)
  - (b) Explain how seasonal and daily weather changes affect Trip Plans.

    **Resources:** [Search and Rescue Expert Stresses Importance of Preparedness (video)](https://youtu.be/CLQo5ftVqnc)
  - (c) Explain and show how a lost Scout could send signals that would alert a ground, airborne, or water SAR team to their location.
    ...
    **Resources:** [5 Ground To Air Signals That Save Lives (video)](https://youtube.com/shorts/Srj6Cy6D0YU), [Various Ways To Signal for Search and Rescue (video)](https://youtu.be/6ZDiIfqTI-k), [Signaling for Help in the Wilderness (website)](https://scoutingmagazine.org/2019/02/signaling-for-help-in-the-wilderness/)
...
- (3) **Maps.** Using a map, a compass and a GPS device or app approved by your counselor, do the following:
  - (a) Point out and explain the 5 D's (Date, Description, Details, Direction or Declination, Distance) of the map.
    ...
    **Resources:** [The 5 D's in Navigation (video)](https://youtu.be/0zbCEXj_29U), [The Five D's in Map Navigation (website)](https://mountaintrails.ie/blog/using-the-five-ds-in-a-navigation-strategy/)
  - (b) Choose a location on the map and record the altitude, latitude, longitude, and US National Grid coordinates. Describe how these coordinate systems differ.
    ...
    **Resources:** [How To Read a US National Grid Map (website)](https://www.fgdc.gov/usng/how-to-read-usng/index_html), [Work With a Grid in ArcGIS Pro (video)](https://youtu.be/Tm-k5d3Ar54)
  - (c) Orient the map and take a bearing to another map location. Estimate the distance between, and describe the terrain between, the two locations.
    ...
    **Resources:** [How To Use a Map and Compass (website)](https://troopleader.scouting.org/rank-advancement-skills/campcraft/navigation-and-measurements/)
  - (d) Show a hypothetical place last seen and point out an area on your map that could be used for containment using natural or human-made boundaries.
    ...
    **Resources:** [Search Containment (video)](https://www.youtube.com/shorts/-fbXrnZ0C3o)
...
- (4) **Incident Command System (ICS).** Do the following:
  - (a) Explain how a local ICS is organized and how it compares with Scouting's patrol method.
    ...
    **Resources:** [Introduction to ICS (video)](https://youtu.be/P-dPBso2xPM), [Incident Command System (website w/ video)](https://www.upstate.edu/emergencymgt/about/incident_command.php)
...
- (5) **SAR Teams.** Do the following:
  - (a) Explain the official duties of a search and rescue team.
    ...
    **Resources:** [What You Should Know As A Search & Rescue Team Member (video)](https://youtu.be/ZF5m_fge5cY)
  - (b) Explain the differences between wilderness, urban, and water SARs.

    **Resources:** [Types of Search and Rescue (website)](https://sregear.com/blogs/news/the-different-types-of-search-and-rescue)
  - (c) Identify four types of search and rescue teams and explain situations where they are used.

    **Resources:** [Types of SAR Teams (website)](https://www.focuspointintl.com/trending/disaster-assistance/understanding-the-different-types-of-search-and-rescue-operations/)
...
- (6) **Search and Rescue Procedures.** Do the following:
  ...
  - (c) Explain the importance of effective communication in SAR operations.
    ...
    **Resources:** [Urban Search and Rescue Communications Specialist Training (video)](https://youtu.be/YE-WG9_IWTc)
  - (d) Explain how predictions of "lost person behavior" determine SAR search plans for a young child, a teenager, and an adult.

    **Resources:** [Lost Person Behavior Scenario (video)](https://youtu.be/e2x38A4aAoU), [Help Us Find You (video)](https://youtu.be/NUgeL0R_qZU)
  - (e) Explain the following terms:

    **Resources:** [Search and Rescue Glossary (website)](https://myem.jibc.ca/wp-content/uploads/2018/04/SAR-Glossary-from-SAR-Mgmt-Course.pdf)

    - (1) Evaluating search urgency

      **Resources:** [Urban Search Urgency Evaluation Form (PDF)](https://www.criminaljustice.ny.gov/missing/docs/search-urgency-chart.pdf)
    - (2) Establishing confinement

      **Resources:** [Establishing Confinement (video)](https://youtu.be/JxWP2D538PY)
    - (3) Scent item
    - (4) Area air scent dog

      **Resources:** [Training For A Search And Rescue (video)](https://youtu.be/2HFOg1LRFmc), [Scent and Rescue Dogs (website)](https://www.buckeyesardogs.org/scent/)
    - (5) Briefing and debriefing

      **Resources:** [Thorns and Roses (website)](https://markaray.wordpress.com/2016/05/17/thorns-and-roses-and-plcs/), [Start, Stop, Continue (video)](https://youtu.be/S__cfVygihk)
    - (6) Clue awareness

      **Resources:** [Clue Awareness (video)](https://youtu.be/luSyvsEcXzs), [Tracking in SAR (website)](https://rescue101sar.org/blog/f/tracking-the-essential-skill-for-search-and-rescue-teams), [Clue Awareness and Detection (PPT)](https://aa3sd.net/newsar/sar_ftm_v1_0_0/presentations/pdf/9_clue_detection.pdf)
    - (7) Evidence preservation

      **Resources:** [Evidence Search (video)](https://www.youtube.com/shorts/ao70uTz9N24)
    - (8) Tracking a subject

      **Resources:** [Footprint Tracking (video)](https://youtu.be/CBYg9TZMvZA), [Dog Scent Tracking Demo (video)](https://youtu.be/bFVckg9ra7o), [Tracking With Drones (video)](https://www.youtube.com/shorts/uNIbbUt-KCY), [Human Tracking, Whistle Science @ 8:30 (video)](https://youtu.be/0GRsfcVZK_A), [Tracking Dog Scent-Preservation (video)](https://youtu.be/yAf0UM-nglk)
    - (9) Locating a subject using attraction

      **Resources:** [Ground Search Techniques (website)](https://www.cibolasar.org/?page_id=478)
    - (10) Hasty search

      **Resources:** [Hasty Searching (video)](https://youtu.be/3_ELcOAH1Iw), [Search Types (video)](https://www.youtube.com/shorts/Mw6V0W4Vyk0)
    - (11) Trail sweep search

      **Resources:** [Conducting a Sound Sweep (website)](https://franklinsar.blogspot.com/2015/12/conducting-sound-sweep-for-search.html)
    - (12) Grid search

      **Resources:** [Zone Search (video)](https://www.youtube.com/shorts/Mw6V0W4Vyk0)
...
- (7) **Plan and Complete a Search.** Do the following with a team of Scouts, friends, or family to execute a practice SAR exercise:
  - (a) Choose a hypothetical SAR scenario, either one presented in the *Search and Rescue* merit badge pamphlet or one approved by your counselor.
    ...
    **Resources:** [Training Scenarios (website)](https://www.countyofglenn.net/government/departments/sheriff/search-rescue/training-response-activities), [Lost Scout Scenario (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Search%20and%20Rescue/Lost%20Scout%20Scenario.pdf)
  - (b) Develop an Incident Action Plan (IAP) for a hasty search using the scenario information.

    **Resources:** [Developing an IAP (PDF)](https://www.sarbc.org/sarbc/pdfs/SearchMgmtActionPlan.pdf)
  - (c) Before the search begins, conduct a PAUSE briefing to review hazards, safety concerns, personal and shared Scout Basic Essentials, and other gear.
    ...
    **Resources:** [Pause. Look. Act. (video)](https://youtu.be/rDSeEBuCyVI), [Risk Assessment (video)](https://youtu.be/FL5jTZJv5Ts), [PAUSE Safety Moment (PDF)](https://filestore.scouting.org/filestore/healthsafety/pdf/680-046.pdf)
  ...
  - (e) After the search, hold a team debriefing to discuss the search, problems, successful and unsuccessful tactics, and ideas for improvement.
    ...
    **Resources:** [Philmont Thorns and Roses (website)](https://markaray.wordpress.com/2016/05/17/thorns-and-roses-and-plcs/)
...
- [Search and Rescue merit badge workbook PDF](http://usscouts.org/mb/worksheets/Search-and-Rescue.pdf)
- [Search and Rescue merit badge workbook DOCX](http://usscouts.org/mb/worksheets/Search-and-Rescue.docx)
