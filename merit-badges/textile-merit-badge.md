...
- (1) Discuss with your counselor the importance of textiles. Explain the terms fiber, fabric, and textile. Give examples of textiles you use every day.
  ...
  **Resources:** [Textiles: What Are They? Where Do They Come From? (video)](https://youtu.be/7-fLaXF6kOs?si=VNaU9JCXzi2FZEq7)
...
- (2) Do the following:
  ...
  - (b) Give the origin, major characteristics, and general content of each type of fiber obtained for 2(a). Explain the difference between a cellulosic manufactured fiber and a synthetic manufactured fiber.
    ...
    **Resources:** [Natural vs Synthetic Fibers (Which to Choose and Why) (video)](https://youtu.be/cRLPUAPCfuo)
  - (c) Describe the main steps in making raw fiber into yarn, and yarn into fabric.

    **Resources:** [From Cotton to Yarn (video)](https://youtu.be/vFaNiTlHeCY), [Weaving Process (video)](https://youtu.be/NIt9SGk55b4), [Knitting Process (video)](https://youtu.be/yRXuKFy89Mg), [Complete Process of Textile Manufacturing Fiber to Complete Garments (video)](https://youtu.be/5nUjGNDImIk)
